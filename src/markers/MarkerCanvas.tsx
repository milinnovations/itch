 ...
 */
class MarkerCanvas extends React.Component<React.PropsWithChildren<MarkerCanvasProps>, MarkerCanvasState> {
    private _containerEl: HTMLDivElement | null = null;
    private _subscription: ((value: { leftOffset: number; date: number; isCursorOverCanvas: boolean }) => void) | null =
        null;
